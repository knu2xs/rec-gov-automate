...
project = 'rec-gov-automate'
copyright = '2023, Joel McCune (https://joelmccune.com)'
author = 'Joel McCune (https://joelmccune.com)'
...
htmlhelp_basename = f'rec_gov_automate_doc'
